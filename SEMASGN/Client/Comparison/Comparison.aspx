...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="w-[80%] min-h-10 m-auto my-10 text-justify ">
        <p class="text-5xl mb-5 font-black">Programme Comparison</p>
        <p class="text-lg">Explore a side-by-side comparison of two academic programs, highlighting both the general admission requirements and specific subject-related criteria. You can easily compare the qualifications and prerequisites for each program, ensuring you make an informed decision based on your academic goals.</p>
    </div>
    <div class="w-[80%] min-h-80 m-auto my-10 text-justify bg-white shadow-lg rounded-lg overflow-hidden">
        <!-- Programme -->
        <div class="w-[100%] min-h-10 border-b bg-gray-100 flex">
            <div class="w-[20%] font-bold min-h-full flex justify-center  p-2">
                <p>Programme</p>
            </div>
            <div class="w-[80%] min-h-full flex">
                <div class="w-[50%] border-l border-gray-300 break-words p-2">
        ...
        <!-- Row 1: Programme ID -->
        <div class="w-[100%] min-h-10 border-b border-gray-300 flex">
            <div class="w-[20%] font-bold min-h-full flex justify-center p-2">
                <p>Programme ID</p>
            </div>
            <div class="w-[80%] min-h-full flex">
        ...
        <div class="w-[100%] min-h-10 border-b border-gray-300 flex">
            ...
            <div class="w-[80%] min-h-full flex">
                ...
                <div class="w-[50%] border-l border-gray-300 break-word p-2">
        ...
        <div class="w-[100%] min-h-10 border-b border-gray-300 flex">
            <div class="w-[20%] font-bold min-h-full flex justify-center p-2 text-center">
